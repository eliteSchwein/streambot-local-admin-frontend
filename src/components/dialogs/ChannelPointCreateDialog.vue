      ...
      <v-card-text class="py-3 px-0">
        ...
        <v-row density="comfortable" class="mb-3 px-3">
          <v-col cols="12" md="4">
            <v-text-field
              v-model="form.name"
              :label="$t('dialogs.channelPointCreateDialog.name')"
              density="comfortable"
              variant="outlined"
              hide-details
            />
          ...
          <v-col cols="12" md="2">
            <v-switch
              ...
              :label="$t('dialogs.channelPointCreateDialog.enableDefault')"
              color="primary"
              density="comfortable"
              hide-details
              inset
          ...
          <v-col cols="12" md="2">
            <v-switch
              ...
              :label="$t('dialogs.channelPointCreateDialog.autoAccept')"
              color="primary"
              density="comfortable"
              hide-details
              inset
          ...
          <v-col cols="12" md="2">
            <v-switch
              ...
              :label="$t('dialogs.channelPointCreateDialog.stripEmotes')"
              color="primary"
              density="comfortable"
              hide-details
              inset
          ...
          <v-col cols="12" md="2">
            <v-switch
              ...
              :label="$t('dialogs.channelPointCreateDialog.inputRequired')"
              color="primary"
              density="comfortable"
              hide-details
              inset
